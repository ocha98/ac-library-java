...
class AssertUtilTest {
    ...
    void testCheckRangeBoundary() {
        ...
        assertThrows(AssertionError.class, () ->{ AssertUtil.checkRange(10, 10); });
        assertThrows(AssertionError.class, () ->{ AssertUtil.checkRange(11, 10); });
        assertThrows(AssertionError.class, () ->{ AssertUtil.checkRange(10, 0, 10); });
        assertThrows(AssertionError.class, () ->{ AssertUtil.checkRange(11, 0, 10); });
        assertThrows(AssertionError.class, () ->{ AssertUtil.checkRange(-1, 10); });
        assertThrows(AssertionError.class, () ->{ AssertUtil.checkRange(-1, 0, 10); });
    }
